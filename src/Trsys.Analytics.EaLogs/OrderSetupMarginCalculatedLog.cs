...
{
    public class OrderSetupMarginCalculatedLog : ILogInfo
    {
        public OrderSetupMarginCalculatedLog()
        {
        }

        public OrderSetupMarginCalculatedLog(DateTimeOffset timestamp, string key, string keyType, string version, string token, decimal freeMargin, long leverage, decimal percentOfFreeMargin, decimal calculatedVolume)
        {
